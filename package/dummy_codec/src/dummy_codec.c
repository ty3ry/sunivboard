...
static struct snd_soc_dai_link_component snd_soc_dai_cpu[] = {
    {
        .dai_name = "sun4i-i2s",
        .name = "sun4i-i2s",
    },
...
static struct snd_soc_dai_link_component snd_soc_dai_codec[] = {
    {
        .name = "pcm5102a-codec",
        .dai_name = "pcm5102a-hifi",
    }
};

static struct snd_soc_dai_link_component snd_soc_dai_platform[] = {
    {
        .name = "sun4i-i2s",
    },
};
...
static struct snd_soc_dai_link snd_rpi_hifiberry_dac_dai[] = {
    {
        ...
        .cpus = &snd_soc_dai_cpu,
        .num_cpus = 1,
        .codecs = &snd_soc_dai_codec,
        .num_codecs = 1,
        .platforms = &snd_soc_dai_platform,
        .num_platforms = 1,
