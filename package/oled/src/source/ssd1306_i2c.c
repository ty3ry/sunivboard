...
#if defined(I2C_USE_WIRINGPI)
	// fd, reg, value
	wiringPiI2CWriteReg8(i2c_fd, control, c);
#else
	// slave address, reg, data
	i2c_write(SSD1306_I2C_ADDRESS, control, c);
#endif
...
#if defined(I2C_USE_WIRINGPI)
		wiringPiI2CWriteReg8(i2c_fd, 0x40, buffer[i]); 

#else
		i2c_write(SSD1306_I2C_ADDRESS, 0x40, buffer[i]);
#endif // I2C_USE_WIRINGPI
